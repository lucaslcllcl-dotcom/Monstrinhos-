...
if vc and vn:
    ...
    try:
        ...
        version_ok=False
checks={'package':'com.caeless.monstrinhos' in text,'save':'monstrinhos_save_v1' in text,'version':version_ok,'launcher':'android.intent.category.LAUNCHER' in text,'admob_integrated':'com.google.android.gms.ads' in text,'billing_integrated':'com.android.billingclient' in text,'child_ad_config':'TAG_FOR_CHILD_DIRECTED_TREATMENT_TRUE' in text and 'MAX_AD_CONTENT_RATING_G' in text,'campaign_30':'safeStage' in text and 'Math.min(30' in text,'save_validation':'validateReleaseState' in text,'accessibility':'textScale()' in text and 'shouldAnimate()' in text}
